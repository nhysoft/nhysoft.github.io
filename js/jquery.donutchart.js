(function($){var defaultsettings={'bgColor':'#ccc','fgColor':'','size':160,'donutwidth':40,'textsize':16}
...
{var percentage=$(this).attr("data-percent");var canvas=$(this).children("canvas").get(0);var percenttext=$(this).find("span");var dcs=this.donutchartsettings;if(canvas.getContext)
