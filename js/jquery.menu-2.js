...
$parent.find(' > .sub-menu').stop(true,true).hide().slideDown()}
else{$parent.find(' > .sub-menu').stop(true,true).show().slideUp(200,function(){$parent.toggleClass('open').trigger('shown.bs.dropdown',relatedTarget)})}
return false}
...
$parent.find(' > .sub-menu').stop(true,true).show().slideUp(200,function(){$parent.removeClass('open').trigger('hidden.bs.dropdown',relatedTarget)})})}
